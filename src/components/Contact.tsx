              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@ischatgptfree.com" className="text-blue-600 hover:text-blue-800 font-medium">
                      contact@ischatgptfree.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">Visit our main platform</p>
                    <a href="https://ischatgptfree.netlify.app" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-800 font-medium">
                      ischatgptfree.netlify.app
                    </a>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="contribution">Prompt Contribution</option>
                  ...
                  <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <p className="text-red-700 font-medium">
                        Failed to send message. Please try again or contact us directly at contact@ischatgptfree.com
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center p-6 bg-blue-50 rounded-lg">
                ...
                <p className="text-gray-600 text-sm">
                  Have an idea for improving our platform? We'd love to hear it!
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-green-50 rounded-lg">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Contribute Prompts</h3>
                <p className="text-gray-600 text-sm">
                  Share your best prompts with our community and help others succeed.
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-orange-50 rounded-lg">
                ...
                <p className="text-gray-600 text-sm">
                  Experiencing problems? Report bugs or get technical assistance.
                </p>
              </div>
            </div>
          </div>
